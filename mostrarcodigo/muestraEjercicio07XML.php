...
<html lang="es">
    ...
    <body>
        <header>      
            <h1 id="inicio">Página web que toma datos de un fichero xml y los añade a la tabla 
                Departamento de nuestra base de datos. (IMPORTAR). El fichero importado se encuentra en el directorio .../tmp/ del servidor</h1>
        </header>
        <main>
            <section>
                <?php
                highlight_file("../codigoPHP/ejercicio07XML.php");
                ?>
            </section>       
        </main>
        <footer>
